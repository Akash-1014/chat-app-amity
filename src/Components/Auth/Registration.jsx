...
console.log("ApiEndpoint", ConnectionStatus);
export const RegisterComp = () => {
  ...
  const apiKey = "b0e8bb583e88a5374e308415550810dcd30888e4ec346e2a"; // add your api key here
  function login() {
  ...
  function registerUser(userId, displayName, email) {
    axios
      .post("https://api.sg.amity.c/v1/users", {
        userId: userId,
